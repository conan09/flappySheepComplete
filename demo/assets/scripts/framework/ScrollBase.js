cc.Class({
    ...
    //itemprefab的updateitem方法如下
    // updateItem(data) {
    //     this.itemIndex.string = data //刷新标签
    // }
        ...
        for (let i in this.items){
            ...
            if(isDown){
                ...
                if(itemPos.y > this.topMax){
                    ...
                    //刷新item内容 
                    item.getComponent('Item').updateItem(this.data[item.__itemID])
                }
                //如果是往上滑动
            }else { 
    ...
    scrollEvent: function(scrollview, eventType, customEventData){
        switch(eventType){
